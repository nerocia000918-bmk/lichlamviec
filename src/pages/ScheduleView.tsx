      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 space-y-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center bg-slate-100 rounded-xl p-1 w-full md:w-auto justify-between">
            ...
            <div className="px-4 font-bold text-slate-800 flex items-center gap-2 text-sm cursor-pointer hover:text-indigo-600 transition-colors" onClick={handleCurrentWeek}>
